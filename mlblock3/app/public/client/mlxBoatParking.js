...
class mlxBoatParking extends mlxElementLocakableOutput {
    ...
    preload() {
        ...
        this.img_step1 = this.p5.loadImage(
            '/assets_game/mlxBoatParking/step2.png'
        );
        this.img_step2 = this.p5.loadImage(
            '/assets_game/mlxBoatParking/step3.png'
        );
        ...
        this.img_heart = this.p5.loadImage(
            '/assets_game/mlxBoatParking/heart.png'
        );
        ...
        this.img_buoy1 = this.p5.loadImage(
            '/assets_game/mlxBoatParking/buoy1.png'
        );
        this.img_buoy2 = this.p5.loadImage(
            '/assets_game/mlxBoatParking/buoy2.png'
        );
        this.img_buoy3 = this.p5.loadImage(
            '/assets_game/mlxBoatParking/buoy3.png'
        );
        this.img_buoy4 = this.p5.loadImage(
            '/assets_game/mlxBoatParking/buoy4.png'
        );

        this.img_rock1 = this.p5.loadImage(
            '/assets_game/mlxBoatParking/rock1.png'
        );
        this.img_rock2 = this.p5.loadImage(
            '/assets_game/mlxBoatParking/rock2.png'
        );

        this.img_right = this.p5.loadImage(
            '/assets_game/mlxBoatParking/right.png'
        );
        this.img_wrong = this.p5.loadImage(
            '/assets_game/mlxBoatParking/wrong.png'
        );
        this.img_heart = this.p5.loadImage(
            '/assets_game/mlxBoatParking/heart.png'
        );
        ...
        this.sound_wave = this.p5.loadSound(
            '/assets_game/mlxBoatParking/wave.mp3'
        );
    }
        ...
        if (!this.delete) {
            ...
            if (!this.drop) {
                ...
                if (this.x < this.xPos[0]) {
                    ...
                    if (this.correct == 1)
                        this.parent.precanvas.image(this.parent.img_right, -21, -42, 42, 42);
                    else if (this.correct == 2)
                        this.parent.precanvas.image(this.parent.img_wrong, -21, -42, 42, 42);
...
class UI_Game {
    ...
    getCurrentAngle() {
        if (this.degreeL == null)
            this.degreeL = this.parent.degree(this.parent.posNose[0], this.parent.posLeftElbow[0]);
        if (this.degreeR == null)
            this.degreeR = this.parent.degree(this.parent.posNose[0], this.parent.posLeftElbow[0]);
        this.degreeL =
            (this.degreeL +
    ...
    drawIntro() {
        ...
        this.parent.precanvas.fill(
            ...
            170,
            0,
            this.parent.p5.abs(this.parent.p5.sin((this.parent.p5.TWO_PI / 50) * this.alpha_2)) *
                255
        );
    ...
    drawOver() {
        ...
        this.parent.precanvas.fill(
            ...
            170,
            0,
            this.parent.p5.abs(this.parent.p5.sin((this.parent.p5.TWO_PI / 50.0) * this.alpha_2)) *
                255
        );
        this.parent.precanvas.textAlign(this.parent.p5.CENTER, this.parent.p5.CENTER);
