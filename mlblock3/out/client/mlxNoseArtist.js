...
class mlxNoseArtist extends mlxElementOutput {
  constructor(mlx) {
    //mlx element
    super(mlx)
    this.title = 'Nose Artist'
    this.category = 'Output'
    this.type = 'NoseArtistGame'
    this.inType = 'posenet'
    ...
    this.cornerText = 'เกมประกอบบทเรียน AI For Kids'
    this.GAMENAME = 'Nose Artist'
    this.OPEN_WEB_ON_FINISH = 'https://www.ml.in.th'
  ...
  preload() {
    ...
    this.img_waiting = this.p5.loadImage('/assets_game/mlxNoseArtist/waiting.png')
  ...
  setup() {
    ...
    //Game Setup
    this.ui = new noseArtistUI(this)
    this.pointer = new noseArtistPointer(this)
    ...
    switch (_actionindex) {
      ...
      case 23:
        ...
        for (var i = 0; i < this.levelPointCount; i++) {
          this.levelPos[i] = new noseArtistDotPoint(
  ...
  setupVirusBall() {
    ...
    for (let i = 0; i < this.numBalls; i++) {
      this.virusBalls[i] = new noseArtistBall(
        this,
...
class noseArtistUI {
  constructor(mlxParent) {
    ...
    this.b_welcome = new noseArtistButton(
      this.parent,
    ...
    /*this.b_level1 = new Button(img_round_n, img_round_d,
      createVector((width / 2) - 150 - 20, height / 2 + 150),
      createVector(80, 80), 40, 21, '1'); //actionIndex = 21
    this.b_level2 = new Button(img_round_n, img_round_d,
      createVector((width / 2) - 75 - 10, height / 2 + 150),
      createVector(80, 80), 40, 21, '2'); //actionIndex = 22*/
    this.b_level3 = new noseArtistButton(
      this.parent,
    ...
    this.b_win = new noseArtistButton(
      this.parent,
      this.parent.img_btbbig_n,
      this.parent.img_btbbig_d,
      this.parent.p5.createVector(this.parent.CV_SIZE_W / 2 + 150, this.parent.CV_SIZE_H / 2 + 150),
  ...
  draw() {
    ...
    if (this.parent.gameMode == 'WELCOME') {
      ...
      this.parent.precanvas.fill(255, 234, 0)
      this.parent.precanvas.textAlign(this.parent.p5.CENTER, this.parent.p5.CENTER)
      //text('เลือกด่าน', (width / 2), (height / 2) - (BG_SIZE_W / 2) + 310);
      //this.b_level1.draw();
      //this.b_level2.draw();
      this.b_level3.draw()
      ...
      if (this.parent.levelFinish) {
        ...
        if (this.parent.currentPoint > 0 && this.parent.currentPoint <= this.parent.displayText.length) {
          ...
          this.parent.precanvas.rect(width - 500, height - 60, 480, 50, 10)
          this.parent.precanvas.imageMode(this.parent.p5.CORNER)
          this.parent.precanvas.image(this.parent.img_doctor, width - 100, height - 176, 100, 176)
          this.parent.precanvas.textAlign(this.parent.p5.LEFT, this.parent.p5.CENTER)
          this.setTextSizeStrokeWeight(25, 0, 3)
          this.parent.precanvas.text(
...
class noseArtistDotPoint {
  ...
  draw() {
    ...
    if (this.pointCount == this.parent.currentPoint) {
      ...
      this.parent.precanvas.image(this.parent.img_point, this.position.x, this.position.y, 45, 45)
