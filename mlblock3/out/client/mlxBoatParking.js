...
class mlxBoatParking extends mlxElementLocakableOutput {
  ...
  preload() {
    ...
    this.img_marker_red = this.p5.loadImage('assets_game/mlxBoatParking/p_marker_red.png')
    this.img_marker = this.p5.loadImage('assets_game/mlxBoatParking/p_marker_black.png')
    ...
    this.img_heart = this.p5.loadImage('assets_game/mlxBoatParking/heart.png')
    this.img_heart_empty = this.p5.loadImage('assets_game/mlxBoatParking/heart_empty.png')
    this.img_waiting = this.p5.loadImage('assets_game/mlxBoatParking/waittoconnect.png')
    ...
    this.sound_changepoint = this.p5.loadSound('assets_game/mlxBoatParking/beep.mp3')
    this.sound_ok = this.p5.loadSound('assets_game/mlxBoatParking/ok.mp3')
    this.sound_falldown = this.p5.loadSound('assets_game/mlxBoatParking/falldown.mp3')
    this.sound_correct = this.p5.loadSound('assets_game/mlxBoatParking/correct.mp3')
    this.sound_movebridge = this.p5.loadSound('assets_game/mlxBoatParking/movebridge.mp3')
    this.sound_wrong = this.p5.loadSound('assets_game/mlxBoatParking/wrong.mp3')
    this.sound_over = this.p5.loadSound('assets_game/mlxBoatParking/gameover.mp3')
    ...
    this.sound_start = this.p5.loadSound('assets_game/mlxBoatParking/music.mp3')
  ...
  setup() {
	...
	*/
    ...
    //Game Setup
    this.imageListY = [this.img_box_y1, this.img_box_y2, this.img_box_y3, this.img_box_y4, this.img_box_yf]
    this.imageListB = [this.img_box_b1, this.img_box_b2, this.img_box_b3, this.img_box_b4, this.img_box_bf]
    this.imageListR = [this.img_box_r1, this.img_box_r2, this.img_box_r3, this.img_box_r4, this.img_box_rf]
    this.imgBuoy = [this.img_buoy1, this.img_buoy2, this.img_buoy3, this.img_buoy4]
    this.Buoy = []
  ...
  draw() {
    if (!this.delete) {
      ...
      if (!this.drop) {
        ...
        if (this.x > this.parent.CV_SIZE_W + this.parent.BOX_W / 2) this.delete = true
        //draw box
        if (this.x < this.xPos[0]) {
          ...
          if (this.correct == 1) this.parent.precanvas.image(this.parent.img_right, -21, -42, 42, 42)
          else if (this.correct == 2) this.parent.precanvas.image(this.parent.img_wrong, -21, -42, 42, 42)
          //check if on the right platform
          if (!this.checked && this.x < this.parent.CV_SIZE_W - 70 && this.targetPlatform == this.originPlatform) {
            //correct platform
            this.correct = 1
...
class UI_Game {
  constructor(mlxParent) {
    ...
    this.degreeL = null
    this.degreeR = null
    this.nextBox = new Box(this.parent, this.parent.p5.random([0, 1, 2]), this.parent.p5.random([0, 1, 2]))
  ...
  draw() {
    ...
    for (var i = 0; i < 5; i++) {
      ...
      if (i < this.parent.HP)
        this.parent.precanvas.image(this.parent.img_heart, this.parent.CV_SIZE_W - 30 - 54 * i, 28)
      else this.parent.precanvas.image(this.parent.img_heart_empty, this.parent.CV_SIZE_W - 30 - 54 * i, 28)
    }
    this.parent.precanvas.pop()
      ...
      if (this.releasebox < 0) {
        ...
        if (boxes.length == 0) {
          ...
          if (choice == 1) {
            ...
            this.nextBox = new Box(this.parent, platform, this.parent.p5.random([0, 1, 2]))
          } else {
  ...
  drawBackground() {
    ...
    this.parent.precanvas.rect(0, 0, this.parent.CV_SIZE_W, this.parent.CV_SIZE_H)
    this.parent.precanvas.imageMode(this.parent.p5.CORNER)
    this.parent.precanvas.image(this.parent.img_bg, 0, 0, this.parent.CV_SIZE_W, this.parent.CV_SIZE_H)
    //image(this.parent.img_building_right, 637, 173, 216, 343);
    this.parent.precanvas.strokeWeight(10)
    this.parent.precanvas.stroke(25, 151, 200)
    this.parent.precanvas.drawingContext.setLineDash([5, 15])
  ...
  drawIntro() {
    this.parent.precanvas.push()
    this.parent.precanvas.imageMode(this.parent.p5.CENTER)
    this.parent.precanvas.image(this.parent.img_logo, this.parent.CV_SIZE_W / 2, this.parent.CV_SIZE_H / 2)
    this.parent.precanvas.pop()
    this.parent.precanvas.push()
    ...
    this.parent.precanvas.text('Raise both hands to Start !!', this.parent.CV_SIZE_W / 2, this.parent.CV_SIZE_H - 70)
    this.parent.precanvas.pop()
  ...
  drawOver() {
    ...
    if (this.parent.checkRaiseHand()) {
      ...
      this.parent.precanvas.text('GAME OVER', this.parent.CV_SIZE_W / 2, this.parent.CV_SIZE_H / 2)
      this.parent.precanvas.pop()
      this.checkingCountDown = 3000
      //store prev data
      this.parent.prevLeftElbowPos = this.parent.posLeftElbow[0]
...
class UI_Calibrate {
  ...
  drawSetupText() {
    this.parent.precanvas.push()
    this.parent.precanvas.imageMode(this.parent.p5.CORNER)
    this.parent.precanvas.image(this.parent.img_mask, 0, 0, this.parent.CV_SIZE_W, this.parent.CV_SIZE_H)
    this.parent.precanvas.fill(255)
    this.parent.precanvas.rect(20, this.parent.CV_SIZE_H - 120, this.parent.CV_SIZE_W - 40, 100, 15)
    //----------------------------------
    // STEP 1
    ...
    if (this.calibrateStep == 'step1') {
      ...
      if (this.checkingCountDown >= 2001) {
        ...
        //start count down
        this.parent.precanvas.text(
          'Stay still (' + (this.parent.p5.int(this.checkingCountDown / 1000) + 1) + ' sec.)',
          this.parent.CV_SIZE_W / 2,
          this.parent.CV_SIZE_H - 70
        )
        this.parent.precanvas.fill(3, 143, 0, 60)
      ...
      this.parent.precanvas.image(this.parent.img_step1, 20, this.parent.CV_SIZE_H - 120 - 231, 263, 231)
      ...
      this.setTextSizeStrokeWeight(25, 0, 5)
      if (this.checkingCountDown >= 2001) {
        this.parent.precanvas.text('Lower both elbows', this.parent.CV_SIZE_W / 2, this.parent.CV_SIZE_H - 70)
      } else {
        //start count down
        this.parent.precanvas.text(
          'Stay still (' + (this.parent.p5.int(this.checkingCountDown / 1000) + 1) + ' sec.)',
      ...
      this.parent.precanvas.image(this.parent.img_step2, 20, this.parent.CV_SIZE_H - 120 - 225, 228, 225)
      this.ratio_w = this.parent.canvas_w / this.parent.inElement.inElement.videoWidth
      this.ratio_h = this.parent.canvas_h / this.parent.inElement.inElement.videoHeight
      this.drawElbowMarker() //draw marker at elbow
