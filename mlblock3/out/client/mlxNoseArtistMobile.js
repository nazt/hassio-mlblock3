...
class mlxNoseArtistMobile extends mlxElementLocakableOutput {
  constructor(mlx) {
    ...
    this.level1Sequence = [26, 312, 410, 312, 50, 601, 222, 167, 393, 601, 26, 312]
    this.level1PointCount = 6
    this.level1NotDrawLint = []
    this.level1NotDrawLintCount = 0

    this.level2Sequence = [
      30, 346, 70, 241, 165, 177, 278, 180, 367, 250, 398, 361, 360, 469, 266, 530, 153, 527, 62, 453, 30, 346, 129,
      407, 159, 436, 210, 450, 261, 436, 291, 406, 159, 303, 159, 255, 261, 255, 261, 303,
    ]
    ...
    this.level3Sequence = [
      58, 611, 58, 409, 58, 204, 387, 409, 58, 611, 387, 611, 387, 409, 387, 204, 58, 409, 387, 611, 387, 409, 58, 409,
      58, 204, 387, 204, 255, 60, 58, 204, 109, 160, 109, 78, 159, 78, 159, 117,
    ]
  ...
  preload() {
    ...
    this.img_pointer = this.p5.loadImage('assets_game/mlxNoseArtist/img_pointer.png')
    this.img_logo = this.p5.loadImage('assets_game/mlxNoseArtist/logo.png')

    this.img_btflip_n = this.p5.loadImage('assets_game/mlxNoseArtist/flipcamera_bt_n.png')
    this.img_btflip_d = this.p5.loadImage('assets_game/mlxNoseArtist/flipcamera_bt_d.png')

    this.img_btbbig_n = this.p5.loadImage('assets_game/mlxNoseArtist/img_btbig_n.png')
    this.img_btbbig_d = this.p5.loadImage('assets_game/mlxNoseArtist/img_btbig_d.png')
    this.img_round_n = this.p5.loadImage('assets_game/mlxNoseArtist/img_round_n.png')
    this.img_round_d = this.p5.loadImage('assets_game/mlxNoseArtist/img_round_d.png')
    this.img_howto1 = this.p5.loadImage('assets_game/mlxNoseArtist/img_howto_1.png')
    this.img_howto2 = this.p5.loadImage('assets_game/mlxNoseArtist/img_howto_2.png')
    this.img_howto3 = this.p5.loadImage('assets_game/mlxNoseArtist/img_howto_3.png')
    this.img_point = this.p5.loadImage('assets_game/mlxNoseArtist/img_pointer_w.png')
    ...
    this.img_waiting = this.p5.loadImage('assets_game/mlxNoseArtist/waiting_mobile.png')
    this.font = this.p5.loadFont('assets_game/mlxNoseArtist/JSJindara-Bold.otf')
    this.sound_button_activated = this.p5.loadSound('assets_game/mlxNoseArtist/button_activated.mp3')
    this.sound_button_touch = this.p5.loadSound('assets_game/mlxNoseArtist/button_touch.mp3')
    this.sound_button_discontact = this.p5.loadSound('assets_game/mlxNoseArtist/button_discontact.mp3')
    this.sound_contact_point = this.p5.loadSound('assets_game/mlxNoseArtist/contact_point.mp3')
    //this.sound_opening = this.p5.loadSound('assets_game/mlxNoseArtist/opening.mp3');
    this.sound_levelcomplete = this.p5.loadSound('assets_game/mlxNoseArtist/levelcomplete.mp3')
    this.sound_sneeze = this.p5.loadSound('assets_game/mlxNoseArtist/sneeze.mp3')
    this.sound_virus_hit = this.p5.loadSound('assets_game/mlxNoseArtist/contact.mp3')
    this.sound_virus = this.p5.loadSound('assets_game/mlxNoseArtist/virus.mp3')
    this.img_virus_1 = this.p5.loadImage('assets_game/mlxNoseArtist/virus5.png')
    this.img_virus_2 = this.p5.loadImage('assets_game/mlxNoseArtist/virus6.png')
    this.img_virus_3 = this.p5.loadImage('assets_game/mlxNoseArtist/virus7.png')
  }
  ...
  draw(p5) {
    ...
    if (this.inElement != null && this.inElement.inElement != null && this.inElement.inElement.videoCapture != null) {
      ...
      this.posNose = this.p5.createVector(this.CV_SIZE_W - this.noseX, this.noseY) //current nose position Vector(flipped video)
      this.ui.draw() //draw
      this.pointer.draw()
      this.precanvas.pop()
    } else {
  ...
  gameButtonAction(_actionindex) {
    switch (_actionindex) {
      ...
      case 21:
        ...
        for (var i = 0; i < this.levelPointCount; i++) {
          this.levelPos[i] = new noseArtistMobileDotPoint(
            this.p5.createVector(this.level1Sequence[i * 2], this.level1Sequence[i * 2 + 1]),
            i,
            this
          )
        }
      ...
      case 22:
        ...
        for (var i = 0; i < this.levelPointCount; i++) {
          this.levelPos[i] = new noseArtistMobileDotPoint(
            this.p5.createVector(this.level2Sequence[i * 2], this.level2Sequence[i * 2 + 1]),
            i,
            this
          )
        }
      ...
      case 23:
        ...
        for (var i = 0; i < this.levelPointCount; i++) {
          this.levelPos[i] = new noseArtistMobileDotPoint(
            this.p5.createVector(this.level3Sequence[i * 2], this.level3Sequence[i * 2 + 1]),
            i,
            this
          )
        }
      ...
      case 4:
        this.pointer.currentActivatedButton = null //clear button in pointer
        //switch Camera
        if (this.inElement != null && this.inElement.inElement != null && this.inElement.inElement.cameraMenu != null) {
...
class noseArtistMobileUI {
  constructor(mlxParent) {
    ...
    this.b_welcome = new noseArtistMobileButton(
      ...
      this.parent.p5.createVector(this.parent.CV_SIZE_W / 2 + 150, this.parent.CV_SIZE_H / 2 + 150),
    ...
    this.b_level1 = new noseArtistMobileButton(
      ...
      this.parent.p5.createVector(this.parent.CV_SIZE_W / 2 - 150 - 20, this.parent.CV_SIZE_H / 2 + 150),
      this.parent.p5.createVector(80, 80),
      40,
      21,
      '1'
    ...
    this.b_level2 = new noseArtistMobileButton(
      ...
      this.parent.img_round_n,
      this.parent.img_round_d,
      this.parent.p5.createVector(this.parent.CV_SIZE_W / 2 - 75 - 10, this.parent.CV_SIZE_H / 2 + 150),
      this.parent.p5.createVector(80, 80),
      40,
      22,
      '2'
    ...
    this.b_level3 = new noseArtistMobileButton(
      ...
      this.parent.img_round_n,
      this.parent.img_round_d,
      this.parent.p5.createVector(this.parent.CV_SIZE_W / 2 - 0, this.parent.CV_SIZE_H / 2 + 150),
      this.parent.p5.createVector(80, 80),
      40,
      23,
      '3'
  ...
  draw() {
    ...
    if (this.parent.gameMode == 'WELCOME') {
      ...
      this.parent.precanvas.image(this.parent.img_logo, width / 2, height / 2 - 50, 250, 250)
      ...
      this.parent.precanvas.text(this.parent.GAMENAME, width / 2, height / 2 + 80)
      this.parent.precanvas.textAlign(this.parent.p5.LEFT, this.parent.p5.CENTER)
      this.setTextSizeStrokeWeight(20, 0, 0)
      this.parent.precanvas.fill(0)
      this.parent.precanvas.text('เกมนี้ใช้จมูกในการเล่น', width / 2 - this.parent.BG_SIZE_W / 2 + 10, height / 2 + 125)
      ...
      this.parent.precanvas.fill(255, 234, 0)
      this.parent.precanvas.textAlign(this.parent.p5.CENTER, this.parent.p5.CENTER)
      this.parent.precanvas.text('เลือกด่าน', width / 2, height / 2 - this.parent.BG_SIZE_W / 2 + 310)
      this.b_level1.draw()
      this.b_level2.draw()
      this.b_level3.draw()
      ...
      for (var i = 0; i < this.parent.currentPoint - 1; i++) {
        ...
        if (drawMe) {
          this.parent.precanvas.stroke(255, 234, 0, this.parent.levelFinish ? 255 : 220)
      ...
      if (this.parent.levelFinish) {
        ...
        if (this.countdown < 0) {
          ...
          this.parent.precanvas.image(this.parent.img_win, width / 2, height / 2 - 50, 250, 170)
          this.parent.precanvas.textAlign(this.parent.p5.LEFT, this.parent.p5.CENTER)
          this.setTextSizeStrokeWeight(20, 0, 3)
          this.parent.precanvas.fill(255, 234, 0)
          this.parent.precanvas.text(
        ...
        this.parent.precanvas.fill(255)
        this.parent.precanvas.textAlign(this.parent.p5.RIGHT, this.parent.p5.CENTER)
        var topText = 'เหลืออีก ' + (this.parent.levelPointCount - this.parent.currentPoint) + 'จุด'
        if (this.parent.currentPoint == 0) topText = 'ไปที่จุดกระพริบเพื่อเริ่มต้น'
        this.parent.precanvas.text(topText, width - 40, 25)
        //----------------------------------
        //DoctorAdvise
        if (this.parent.currentPoint > 0 && this.parent.currentPoint <= this.parent.displayText.length) {
          this.setTextSizeStrokeWeight(25, 0, 3)
          ...
          this.parent.precanvas.image(this.parent.img_doctor, width - 50, height - 98, 50, 98)
          this.parent.precanvas.textAlign(this.parent.p5.LEFT, this.parent.p5.CENTER)
          this.setTextSizeStrokeWeight(20, 0, 3)
          this.parent.precanvas.text(this.parent.displayText[this.parent.currentPoint - 1], 10, height - 60, 440, 50)
        }
        //----------------------------------
        this.parent.precanvas.pop()
        //----------------------
        if (this.parent.levelOver) {
          ...
          this.parent.precanvas.image(this.parent.img_lose, width / 2, height / 2 - 50, 220, 250)
          this.parent.precanvas.textAlign(this.parent.p5.LEFT, this.parent.p5.CENTER)
          this.setTextSizeStrokeWeight(20, 0, 3)
...
class noseArtistMobilePointer {
  ...
  draw() {
    this.parent.precanvas.push()
    this.parent.precanvas.imageMode(this.parent.p5.CENTER)
    this.position = this.parent.p5.createVector(this.parent.posNose.x, this.parent.posNose.y) //for virus checking
    this.parent.precanvas.image(this.parent.img_pointer, this.parent.posNose.x, this.parent.posNose.y) //pointer on top
    this.parent.precanvas.pop()
    //-------------------------
    //For Button Action
    ...
    //--------------------------
    //For DotPoint Action
    if (this.currentDotPoint != null && this.currentDotPoint.pointCount == this.parent.currentPoint) {
  ...
  showTimerForDotPoint() {
    ...
    if (this.timerDotPoint > this.parent.DOTPOINT_ACTIVATED_TIME) {
      ...
      this.parent.precanvas.push()
      this.parent.precanvas.fill(0)
      this.parent.precanvas.rect(this.parent.posNose.x - 25, this.parent.posNose.y - 33, 50, 15)
      this.parent.precanvas.fill(255, 234, 0)
...
class noseArtistMobileDotPoint {
  ...
  draw() {
    ...
    if (this.pointCount == this.parent.currentPoint) {
      ...
      this.parent.precanvas.tint(
        ...
        0,
        0,
        this.parent.p5.abs(this.parent.p5.sin((this.parent.p5.TWO_PI / 50.0) * this.alpha_1)) * 255
      )
      this.parent.precanvas.image(this.parent.img_point, this.position.x, this.position.y, 50, 50)
      ...
      } else if (this.pointCount > this.parent.currentPoint && this.pointCount < this.parent.currentPoint + 5) {
        //Neat Future point
        this.parent.precanvas.tint(255, 234, 0, 150 * ((5 - (this.pointCount - this.parent.currentPoint)) / 5.0))
      } else {
        this.parent.precanvas.tint(80, 24)
      }
      this.parent.precanvas.image(this.parent.img_point, this.position.x, this.position.y, 25, 25)
    }
    this.parent.precanvas.pop()
  }
  ...
  collideRound(pointerPos) {
    var dist = this.parent.p5.sqrt(
      this.parent.p5.pow(this.position.x - pointerPos.x, 2) + this.parent.p5.pow(this.position.y - pointerPos.y, 2)
    )
...
class noseArtistMobileButton {
  constructor(mlxParent, _img_button, _img_button_down, _posVector, _sizeVector, _radius, _actionIndex, _text) {
    this.parent = mlxParent
  ...
  draw() {
    ...
    if (
      ...
      (this.radius == 0 && this.collideRect(this.parent.posNose, this.VectorOne))
    ) {
      //pointer is on button
      this.parent.precanvas.image(this.img_down, this.position.x, this.position.y, this.size.x, this.size.y)
      //------------------------------
      //set current button to pointer
      this.parent.pointer.currentActivatedButton = this
      //------------------------------
    } else {
      this.parent.precanvas.image(this.img, this.position.x, this.position.y, this.size.x, this.size.y)
      //------------------------------
      //unassigned button to pointer
      if (this.parent.pointer.currentActivatedButton == this) {
        if (!this.parent.pointer.buttonActivated) this.parent.sound_button_discontact.play() //play discontact sound only when button is not activated
...
class noseArtistMobileBall {
  constructor(mlxParent, xin, yin, din, idin, oin) {
    ...
    this.id = idin
    this.others = oin
    this.image = this.parent.img_virus[this.parent.p5.int(this.parent.p5.random(100) % 3)]
  }
  ...
  collide() {
    ...
    if (this.parent.currentPoint == 0) {
      ...
      safeArea = [this.parent.levelPos[this.parent.currentPoint], this.parent.levelPos[this.parent.currentPoint - 1]]
      count = 2
    }
    ...
    if (distance < minDist) {
      ...
      if (this.parent.hp <= 0 && !this.parent.levelOver) {
        ...
        if (!this.parent.sound_sneeze.isPlaying()) this.parent.sound_sneeze.play()
      } else {
        //play hit sound
        if (!this.parent.levelOver && !this.parent.sound_virus_hit.isPlaying()) this.parent.sound_virus_hit.play()
      }
      let angle = this.parent.p5.atan2(dy, dx)
      let targetX = this.x + this.parent.p5.cos(angle) * minDist
      let targetY = this.y + this.parent.p5.sin(angle) * minDist
  ...
  display() {
    this.parent.precanvas.push()
    this.parent.precanvas.imageMode(this.parent.p5.CENTER)
    this.parent.precanvas.image(this.image, this.x, this.y, this.diameter + 3, this.diameter + 3)
